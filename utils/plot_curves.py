...
def plot_pr_curve(recalls, precisions, auc, x_axis=1, figure_size=[5, 4], pixel=300, resolution=300):
    plt.rcParams['savefig.dpi'] = pixel  # pixel
    plt.rcParams['figure.dpi'] = resolution  # resolution
    plt.rcParams["figure.figsize"] = figure_size  # figure size
